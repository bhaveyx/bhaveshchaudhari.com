...
export async function generateOGImage({
  ...
  try {
    const interSemiBold = fetch(new URL("../../public/fonts/Inter-SemiBold.ttf", import.meta.url))
      .then((res) => res.arrayBuffer())
      .catch(() => null)

    const interRegular = fetch(new URL("../../public/fonts/Inter-Regular.ttf", import.meta.url))
      .then((res) => res.arrayBuffer())
      .catch(() => null)

    const [interSemiBoldData, interRegularData] = await Promise.all([interSemiBold, interRegular])
