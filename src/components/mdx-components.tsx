...
export const mdxComponents = {
    ...
    p: ({ children, ...props }: { children: React.ReactNode }) => (
        <p
            className="text-gray-800 dark:text-gray-200 leading-relaxed mb-6"
            {...props}
        >
            {children}
        </p>
    ...
    ul: ({ children, ...props }: { children: React.ReactNode }) => (
        <ul
            className="list-disc list-inside text-gray-800 dark:text-gray-200 mb-6 space-y-2 ml-4"
            {...props}
        >
            {children}
        </ul>
    ...
    ol: ({ children, ...props }: { children: React.ReactNode }) => (
        <ol
            className="list-decimal list-inside text-gray-800 dark:text-gray-200 mb-6 space-y-2 ml-4"
            {...props}
        >
            {children}
        </ol>
