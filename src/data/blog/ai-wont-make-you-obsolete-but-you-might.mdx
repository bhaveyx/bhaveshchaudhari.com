...
excerpt: "AI won’t replace you, but shallow work will. Use it without losing your skills or curiosity."
category: "Think piece"
tags: ["AI"]
metaDescription: "AI won’t replace you, but shallow work will. Use it without losing your skills or curiosity."
keywords: ["ai"]
featured: true
...
This is the paradox of AI, the very thing that promise to make us more productive can quietly erode the understanding that makes us valuable.
...
>
  ![The paradox of AI productivity](/blog/1/cycle-of-civilization-tweet.webp)
</a>
...
I’ve experienced this firsthand. While reviewing PRs, I have came across ton of AI written code and at this point I have learned to recognize it.
...
So if how we use AI is what truly determines our growth, how can we harness it such that it doesn't dull our skills our judgement?
...
- Verify the output: Coding assistants like claude code, gemini cli, etc. are prompted [e.g. see Gemini CLI system prompt](https://github.com/google-gemini/gemini-cli/blob/main/packages/core/src/core/prompts.ts#L61) to verify the written code it's giving, it does so by either running any test setup present in the project, or by running build commands, etc. But as of now, they’re far from perfect, they still hallucinate and make mistakes. You must take responsibility for reviewing what’s actually happening.
